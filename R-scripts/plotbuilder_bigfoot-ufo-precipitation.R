#plotbuilder for bigfoot, ufo maps and scatter plots
#2025.12.10
...
plot_bigfoot_vs_ufo <- ggplot(county_data %>% filter(Bigfoot_Count > 0, UFO_Count > 0), 
  ...
  labs(
    title = "UFO vs Bigfoot Sightings by County",
...
ggsave("plot_bigfoot_vs_ufo.png",
       plot = plot_bigfoot_vs_ufo,       # Specify the plot object (optional if it's the last one shown)
...
ggsave("plot_ufo_vs_precip.png",
       plot = plot_ufo_vs_precip,       # Specify the plot object (optional if it's the last one shown)
       width = 8,           # Width in specified units
       height = 6,          # Height in specified units
       units = "in",        # Units (inches is default, others are "cm", "mm")
       dpi = 300,           # Resolution (dots per inch, "retina" or "screen" are also options)
...
ggsave("plot_bigfoot_vs_ufo_percap.png",
       plot = plot_bigfoot_vs_ufo_percap,       # Specify the plot object (optional if it's the last one shown)
       width = 8,           # Width in specified units
       height = 6,          # Height in specified units
       units = "in",        # Units (inches is default, others are "cm", "mm")
       dpi = 300,           # Resolution (dots per inch, "retina" or "screen" are also options)
...
ggsave("plot_ufo_vs_precip_percap.png",
       plot = plot_ufo_vs_precip_percap,       # Specify the plot object (optional if it's the last one shown)
       width = 8,           # Width in specified units
       height = 6,          # Height in specified units
       units = "in",        # Units (inches is default, others are "cm", "mm")
       dpi = 300,           # Resolution (dots per inch, "retina" or "screen" are also options)
...
ggsave("plot_log_bigfoot_vs_ufo.png",
       plot = plot_log_bigfoot_vs_ufo,       # Specify the plot object (optional if it's the last one shown)
       width = 8,           # Width in specified units
       height = 6,          # Height in specified units
       units = "in",        # Units (inches is default, others are "cm", "mm")
       dpi = 300,           # Resolution (dots per inch, "retina" or "screen" are also options)
